train_src=/corpora/yahoo_answers/final_data/Family_Relationships/train/answers.Family_Relationships.sents.batches1_36.10x.answers.Family_Relationships.sents.batches0036_1564.filtered.smt.tok.informal
train_tgt=/corpora/yahoo_answers/final_data/Family_Relationships/train/answers.Family_Relationships.sents.batches1_36.10x.answers.Family_Relationships.sents.batches0036_1564.filtered.smt.tok.formal
...
save_data=/corpora/yahoo_answers/final_data/Family_Relationships/OpenNMT-lua/answers.Family_Relationships.sents.batches1_36.10x.answers.Family_Relationships.sents.batches0036_1564.filtered.smt
...
th train.lua -encoder_type brnn -data $save_data-train.t7 -save_model $save_data.model.selftraining10x.nmtbpe -pre_word_vecs_enc $save_data.src.answer.emb-embeddings-300.t7 -src_word_vec_size 300 -pre_word_vecs_dec $save_data.tgt.answer.emb-embeddings-300.t7 -tgt_word_vec_size 300 -end_epoch 30 -gpuid 1 -tok_src_bpe_model $train_src.bpe.model -tok_tgt_bpe_model $train_tgt.bpe.model
