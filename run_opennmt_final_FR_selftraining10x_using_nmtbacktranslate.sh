...
th train.lua -encoder_type brnn -data $save_data-train.t7 -save_model $save_data.model.selftraining10x.usingnmtbacktranslate -pre_word_vecs_enc $save_data.src.answer.emb-embeddings-300.t7 -src_word_vec_size 300 -pre_word_vecs_dec $save_data.tgt.answer.emb-embeddings-300.t7 -tgt_word_vec_size 300 -fix_word_vecs_enc -fix_word_vecs_dec -end_epoch 30 -gpuid 1 -train_from /corpora/yahoo_answers/final_data/Family_Relationships/OpenNMT-lua/answers.Family_Relationships.sents.batches1_36.10x.answers.Family_Relationships.sents.batches0036_1564.filtered.smt.Family_Relationships.model.selftraining10x.usingnmtbacktranslate_epoch5_15.21.t7 -continue 
