informal_file=/corpora/yahoo_answers/final_data/Family_Relationships/test/answers.Family_Relationships.sents.batch0040.org.tok.informal

declare -a files=("/corpora/yahoo_answers/final_data/Family_Relationships/test/answers.Family_Relationships.sents.batch0040.tok.informal" 
...
for file in "${files[@]}"; do
	th predictwithSIC.lua -informal_file $informal_file -formal_file $file	
done
