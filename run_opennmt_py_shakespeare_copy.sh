...
python train.py -data $save_data -save_model $save_data.model.copy -gpuid 0 -epochs 30 -encoder_type brnn -src_word_vec_size 300 -tgt_word_vec_size 300 -copy_attn_force 
