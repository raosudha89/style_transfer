...
th train.lua -encoder_type brnn -data $save_data-train.t7 -save_model $save_data.model.selftraining10x.usinglm -pre_word_vecs_enc $save_data.src.answer.emb-embeddings-300.t7 -src_word_vec_size 300 -pre_word_vecs_dec $save_data.tgt.answer.emb-embeddings-300.t7 -tgt_word_vec_size 300 -end_epoch 30 -gpuid 1 -lm_model /corpora/yahoo_answers/final_data/Family_Relationships/OpenNMT-lua/Family_Relationships.tok.formal.lm.model_epoch13_24.83.t7
